function [hdr, record] = edfread(fname, varargin)
    ...
    for ii = 1:2:numel(varargin)
        ...
        switch lower(varargin{ii})
            ...
            otherwise
                error('EDFREAD:Unrecognized parameter - value pair specified. Valid values are ''assignToVariables'', ''verbose'', and ''targetSignals''.')
        end
    ...
    if verbose
        disp('Step 1 of 2: Reading requested records. (This may take a few seconds.)...');
    end
