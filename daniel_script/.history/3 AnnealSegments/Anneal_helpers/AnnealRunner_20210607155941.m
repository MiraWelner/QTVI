...
%         disp('Anealing segments...');
        	[annealedSegments, final_bin_idx] = AnnealSegments(ppg, ppgSamplingRate, ecg, ecgSamplingRate, noiseSEG, scoring_epoch_size_sec, sleepStages, AnnealSegments_segment_size_mins, rs, 0);
        end
%         for x = 1:length(annealedSegments)
