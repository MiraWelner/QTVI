...
public:
    ...
    void setupUi(QDialog *noise_marking_gui)
    {
        ...
        buttons->addLayout(gridLayout_2, 1, 2, 1, 1);
        ...
        buttons->addLayout(gridLayout_3, 1, 0, 1, 1);
